...
*/
trigger OpportunityTrigger on Opportunity (before update, before delete, before insert, after update, after insert, after delete, after undelete) {
    
    OpportunityTriggerHandler oth = new OpportunityTriggerHandler(Trigger.new, Trigger.old, Trigger.newMap, Trigger.oldMap);
    oth.run();
}